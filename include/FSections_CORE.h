...
#if !defined(DYM48B_SECT_SECT) && !defined(DYM48B_SECT_TAPS)
	#define  DYM48B_SECT      30
    section  ("seg_dmda2")    float     DYM48B_L[DYM48B_SECT*2+ 1];
    section  ("seg_dmda2")    float     DYM48B_R[DYM48B_SECT*2+ 1];
	#include "DYM48B_TUN_96_x2_B12_24000Hz_-3dB@7830_-60dB@10760Hz_RIPPLE_27.3dB_PRE11_POST110.h"
#endif
...
//  OVERSAMPLING
  ...
  #include "OVT19B_TUN_B127_BUT5_800Hz_-6dB@20_-30dB@20Hz_RIPPLE_83.7dB_PRE123_POST1090.h"
    ...
    section  ("seg_dmda2")    float     VVT19A_L[VVT19A_SECT*2+ 1];
    section  ("seg_dmda2")    float     VVT19A_R[VVT19A_SECT*2+ 1];
...
#if !defined(MCOVS48_w_SECT) && !defined(MCOVS48_w_TAPS)
    #define  MCOVS48_w_SECT      3
    section  ("seg_dmda2")    float dm MCOVS48_w_L[MCOVS48_w_SECT*2+ 1];
    section  ("seg_dmda2")    float dm MCOVS48_w_R[MCOVS48_w_SECT*2+ 1];
  #include    "MCOVS48_w_18000Hz_-6dB@SR.h"
#endif

#if !defined(MCOVS44_w_SECT) && !defined(MCOVS44_w_TAPS)
    #define  MCOVS44_w_SECT      3
    section  ("seg_dmda2")    float dm MCOVS44_w_L[MCOVS44_w_SECT*2+ 1];
    section  ("seg_dmda2")    float dm MCOVS44_w_R[MCOVS44_w_SECT*2+ 1];
  #include    "MCOVS44_w_18000Hz_-6dB@SR.h"
#endif

#if !defined(MCOVS44_h4_SECT) && !defined(MCOVS44_h4_TAPS)
    #define  MCOVS44_h4_SECT      3
    section  ("seg_dmda2")    float dm MCOVS44_h4_L[MCOVS44_h4_SECT*2+ 1];
    section  ("seg_dmda2")    float dm MCOVS44_h4_R[MCOVS44_h4_SECT*2+ 1];
  #include    "MCOVS44_h4_17000Hz_-6dB@SR.h"
#endif

#if !defined(MCOVS48_h4_SECT) && !defined(MCOVS48_h4_TAPS)
    #define  MCOVS48_h4_SECT      3
    section  ("seg_dmda2")    float dm MCOVS48_h4_L[MCOVS48_h4_SECT*2+ 1];
    section  ("seg_dmda2")    float dm MCOVS48_h4_R[MCOVS48_h4_SECT*2+ 1];
  #include    "MCOVS48_h4_18000Hz_-6dB@SR.h"
#endif

#if !defined(MCOVS44_h63_SECT) && !defined(MCOVS44_h63_TAPS)
    #define  MCOVS44_h63_SECT      3
    section  ("seg_dmda2")    float dm MCOVS44_h63_L[MCOVS44_h63_SECT*2+ 1];
    section  ("seg_dmda2")    float dm MCOVS44_h63_R[MCOVS44_h63_SECT*2+ 1];
  #include    "MCOVS44_h63_18000Hz_-6dB@SR.h"
#endif

#if !defined(MCOVS48_h63_SECT) && !defined(MCOVS48_h63_TAPS)
    #define  MCOVS48_h63_SECT      3
    section  ("seg_dmda2")    float dm MCOVS48_h63_L[MCOVS48_h63_SECT*2+ 1];
    section  ("seg_dmda2")    float dm MCOVS48_h63_R[MCOVS48_h63_SECT*2+ 1];
  #include    "MCOVS48_h63_18000Hz_-6dB@SR.h"
#endif

#if !defined(MCOVS44_h65_SECT) && !defined(MCOVS44_h65_TAPS)
    #define  MCOVS44_h65_SECT      3
    section  ("seg_dmda2")    float dm MCOVS44_h65_L[MCOVS44_h65_SECT*2+ 1];
    section  ("seg_dmda2")    float dm MCOVS44_h65_R[MCOVS44_h65_SECT*2+ 1];
  #include    "MCOVS44_h65_18000Hz_-6dB@SR.h"
#endif

#if !defined(MCOVS48_h65_SECT) && !defined(MCOVS48_h65_TAPS)
    #define  MCOVS48_h65_SECT      3
    section  ("seg_dmda2")    float dm MCOVS48_h65_L[MCOVS48_h65_SECT*2+ 1];
    section  ("seg_dmda2")    float dm MCOVS48_h65_R[MCOVS48_h65_SECT*2+ 1];
  #include    "MCOVS48_h65_18000Hz_-6dB@SR.h"
#endif

#if !defined(DIRACx1_SECT) && !defined(DIRACx1_TAPS)
    #define  DIRACx1_SECT      1
    section  ("seg_dmda2")    float dm DIRACx1_L[DIRACx1_SECT*2+ 1];
    section  ("seg_dmda2")    float dm DIRACx1_R[DIRACx1_SECT*2+ 1];
  #include    "DIRACx1.h"
#endif
